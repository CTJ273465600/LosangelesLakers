...
//符号
static const rt_uint16_t morse_dian[7]  = {MORSE_DIAN, MORSE_HUA, MORSE_DIAN, MORSE_HUA, MORSE_DIAN, MORSE_HUA, MORSE_ZIFU_KONG};                  //.-.-.-//.
static const rt_uint16_t morse_mao[7]  = {MORSE_HUA, MORSE_HUA, MORSE_HUA, MORSE_DIAN, MORSE_DIAN, MORSE_DIAN, MORSE_ZIFU_KONG};                   //---...//:
static const rt_uint16_t morse_dou[7]  = {MORSE_HUA, MORSE_HUA, MORSE_DIAN, MORSE_DIAN, MORSE_HUA, MORSE_HUA, MORSE_ZIFU_KONG};                    //--..--//,
static const rt_uint16_t morse_fen[7]  = {MORSE_HUA, MORSE_DIAN, MORSE_HUA, MORSE_DIAN, MORSE_HUA, MORSE_DIAN, MORSE_ZIFU_KONG};                   //-.-.-.//;
static const rt_uint16_t morse_wen[7]  = {MORSE_DIAN, MORSE_DIAN, MORSE_HUA, MORSE_HUA, MORSE_DIAN, MORSE_DIAN, MORSE_ZIFU_KONG};                  //..--..//?
static const rt_uint16_t morse_deng[6]  = {MORSE_HUA, MORSE_DIAN, MORSE_DIAN, MORSE_DIAN, MORSE_HUA, MORSE_ZIFU_KONG};                             //-...-//=
static const rt_uint16_t morse_danyin[7]  = {MORSE_DIAN, MORSE_HUA, MORSE_HUA, MORSE_HUA, MORSE_HUA, MORSE_DIAN, MORSE_ZIFU_KONG};                 //.----.//'
static const rt_uint16_t morse_xie[6]  = {MORSE_HUA, MORSE_DIAN, MORSE_DIAN, MORSE_HUA, MORSE_DIAN, MORSE_ZIFU_KONG};                              //-..-.///
static const rt_uint16_t morse_jing[7]  = {MORSE_HUA, MORSE_DIAN, MORSE_HUA, MORSE_DIAN, MORSE_HUA, MORSE_HUA, MORSE_ZIFU_KONG};                   //-.-.--//!
static const rt_uint16_t morse_hua[7]  = {MORSE_HUA, MORSE_DIAN, MORSE_DIAN, MORSE_DIAN, MORSE_DIAN, MORSE_HUA, MORSE_ZIFU_KONG};                  //-....-//-
static const rt_uint16_t morse_xiahua[7]  = {MORSE_DIAN, MORSE_DIAN, MORSE_HUA, MORSE_HUA, MORSE_DIAN, MORSE_HUA, MORSE_ZIFU_KONG};                //..--.-//_
static const rt_uint16_t morse_shuangyin[7]  = {MORSE_DIAN, MORSE_HUA, MORSE_DIAN, MORSE_DIAN, MORSE_HUA, MORSE_DIAN, MORSE_ZIFU_KONG};            //.-..-.//"
static const rt_uint16_t morse_zuokuo[6]  = {MORSE_HUA, MORSE_DIAN, MORSE_HUA, MORSE_HUA, MORSE_DIAN, MORSE_ZIFU_KONG};                            //-.--.//(
static const rt_uint16_t morse_youkuo[7]  = {MORSE_HUA, MORSE_DIAN, MORSE_HUA, MORSE_HUA, MORSE_DIAN, MORSE_HUA, MORSE_ZIFU_KONG};                 //-.--.-//)
static const rt_uint16_t morse_meiyuan[8]  = {MORSE_DIAN, MORSE_DIAN, MORSE_DIAN, MORSE_HUA, MORSE_DIAN, MORSE_DIAN, MORSE_HUA, MORSE_ZIFU_KONG};  //...-..-//$
static const rt_uint16_t morse_and[5]  = {MORSE_DIAN, MORSE_DIAN, MORSE_DIAN, MORSE_DIAN, MORSE_ZIFU_KONG};                                        //...-//&
static const rt_uint16_t morse_at[7]  = {MORSE_DIAN, MORSE_HUA, MORSE_HUA, MORSE_DIAN, MORSE_HUA, MORSE_DIAN, MORSE_ZIFU_KONG};                    //.--.-.//@
