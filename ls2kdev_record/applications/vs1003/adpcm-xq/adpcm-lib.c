...
static void 
encode_chunks (struct adpcm_context *pcnxt, uint8_t **outbuf, size_t *outbufsize, const int16_t **inbuf, int inbufcount)
{
...
int adpcm_encode_block (void *p, uint8_t *outbuf, size_t *outbufsize, const int16_t *inbuf, int inbufcount)
{
    ...
    *outbufsize = 0;
    ...
    get_decode_parameters(pcnxt, init_pcmdata, init_index);                 //11.11
